...
import { Button, ButtonIcon, ButtonFloatingAction } from '@template/components/buttons';
import { Checkbox, CheckboxItem, Radio, RadioItem, Switch } from '@template/components/controls';
import { Select, TextField, TextFieldIcon, TextFieldGroup, TextBox, TextBoxGroup } from '@template/components/form-elements';
import { Badge, Tag } from '@template/components/labels';
import { RowItem, RowMessage } from '@template/components/list';
import { Icon, Image } from '@template/components/media';
import { TooltipDirective } from '@template/directives/tooltip';
import { INTERFACE_INTERACTION, USERS_PEOPLE, EMOTICON, FOOD_DRINK, DATA_VISUALIZATION } from '@template/models/icon-library';
import { IOption } from '@template/models/interfaces';
import { ToastService } from '@template/services/toast';
import { EColor, EOverlayPosition } from '@template/models/enums';
...
export class Showcase {
  ...
  protected readonly color = EColor;
  protected readonly position = EOverlayPosition;
