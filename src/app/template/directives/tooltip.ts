...
import { Tooltip } from '@template/components/information/tooltip/tooltip';
...
export class TooltipDirective implements OnDestroy {
  ...
  readonly position = input<EOverlayPosition>(EOverlayPosition.DEFAULT);
  readonly color = input<EColor>(EColor.WHITE);
  ...
  onMouseMove(event: MouseEvent): void {
    if (this.componentRef !== null && this.position() === EOverlayPosition.DYNAMIC) {
